...
export function NovaMetricCard({
  ...
  return (
    <div
      className={cn(
        "group nova-surface relative flex min-h-[122px] gap-4 overflow-hidden rounded-[18px] px-4 py-4 text-[color:var(--theme-body-text)] transition-shadow duration-300 hover:[box-shadow:0_0_24px_rgba(99,179,255,0.15),0_8px_32px_rgba(0,0,0,0.4)] sm:min-h-[136px] sm:rounded-[20px] sm:px-5 sm:py-[18px]",
        className
      )}
      style={{
