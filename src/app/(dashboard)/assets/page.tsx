...
import { getCachedAssetsData, loadAssetsData } from "@/features/assets/data-loader";
...
export default function AssetsPage() {
  const initialItems = getCachedAssetsData(DEFAULT_DISPLAY_CURRENCY);
  ...
  const loadItems = useCallback(async () => {
    const cachedItems = getCachedAssetsData(displayCurrency);
    if (cachedItems) {
    ...
    try {
      const nextItems = await loadAssetsData(displayCurrency);
