    ...
    <>
      {!isOpen && (
        <button
          ...
          className="fixed bottom-8 right-6 z-40 inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-4 py-3 text-sm font-medium text-slate-700 shadow-[0_18px_44px_rgba(15,23,42,0.16)] transition hover:border-slate-300 hover:text-slate-950"
        >
      ...
      {isOpen && (
        <div className="fixed bottom-24 right-6 z-40 w-[432px] rounded-2xl border border-slate-200 bg-white p-3.5 shadow-md">
