...
export function Header() {
  ...
  return (
    <header className="rounded-[18px] border [background:var(--theme-header-bg)] [border-color:var(--theme-header-border)] [box-shadow:var(--theme-header-shadow)] sm:rounded-[20px]">
