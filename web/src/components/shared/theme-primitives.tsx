...
export const THEME_DIALOG_INPUT_CLASS =
  "h-11 rounded-2xl border-slate-200 bg-white text-slate-950 placeholder:text-slate-400 shadow-none";

export const THEME_DIALOG_SELECT_CLASS =
  "h-11 w-full appearance-none rounded-2xl border border-slate-200 bg-white px-3 text-sm text-slate-950 transition outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:cursor-not-allowed disabled:bg-slate-50 disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20";

export const THEME_TEXTAREA_CLASS =
  "min-h-[96px] w-full rounded-[20px] border border-slate-200 bg-white px-3 py-2.5 text-sm text-slate-950 transition outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50";

export const THEME_COMPACT_SELECT_CLASS =
  "rounded-2xl border border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-950 transition outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50";
...
export const THEME_ICON_BUTTON_CLASS =
  "inline-flex h-10 w-10 items-center justify-center rounded-2xl border border-slate-200 bg-white text-slate-400 transition hover:border-slate-300 hover:text-slate-700";

export const THEME_LIST_ITEM_CLASS =
  "flex items-center justify-between rounded-2xl border border-slate-200 bg-white px-4 py-3 text-xs transition hover:border-slate-300 hover:bg-slate-50 sm:text-sm";

export const THEME_STATUS_SUCCESS_SURFACE_CLASS = "border-green-200 bg-green-50";

export const THEME_STATUS_SUCCESS_SOFT_SURFACE_CLASS = "border-green-200 bg-green-50/70";

export const THEME_STATUS_NEUTRAL_SURFACE_CLASS = "border-slate-200 bg-white hover:border-slate-300";

export const THEME_STATUS_MUTED_SURFACE_CLASS = "border-slate-200 bg-slate-50/70";
