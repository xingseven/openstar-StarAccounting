...
>(({ className, children, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed inset-x-0 bottom-0 z-50 mx-auto grid w-full max-w-lg gap-4 rounded-t-[28px] border px-4 pb-[calc(1rem+env(safe-area-inset-bottom))] pt-3 shadow-[0_-18px_48px_rgba(15,23,42,0.18)] outline-none sm:px-6 sm:pb-6 sm:pt-5",
