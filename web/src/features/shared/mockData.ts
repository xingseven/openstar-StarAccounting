...
export const MOCK_CONSUMPTION: ConsumptionData = {
  ...
  insights: {
    spendingStyle: [
      { name: "固定支出", value: 3680, share: 29.3, fill: "#1d4ed8", description: "租房、缴费、订阅类" },
      { name: "弹性支出", value: 5120, share: 40.7, fill: "#2563eb", description: "日常可调节开支" },
      { name: "冲动消费", value: 3780, share: 30.0, fill: "#60a5fa", description: "夜间/购物娱乐型" },
    ],
    necessitySplit: [
      { name: "必要消费", value: 7020, share: 55.8, fill: "#1d4ed8" },
      { name: "可选消费", value: 5560, share: 44.2, fill: "#60a5fa" },
    ],
    transactionNature: [
      { name: "真实消费", value: 11240, share: 89.3, fill: "#1d4ed8" },
      { name: "转账/还款", value: 980, share: 7.8, fill: "#2563eb" },
      { name: "退款回流", value: 360, share: 2.9, fill: "#60a5fa" },
    ],
    recurringMerchants: [
    ...
    remarkBreakdown: [
      { name: "每月房租", total: 2500, count: 1, share: 19.9, category: "住房", merchant: "房东", fill: "#1d4ed8" },
      { name: "给家里", total: 960, count: 2, share: 7.6, category: "转账支出", merchant: "家人", fill: "#2563eb" },
      { name: "水电费", total: 468, count: 3, share: 3.7, category: "生活", merchant: "物业", fill: "#3b82f6" },
      { name: "固定订阅", total: 388, count: 4, share: 3.1, category: "娱乐", merchant: "腾讯视频", fill: "#60a5fa" },
      { name: "孩子兴趣班", total: 320, count: 2, share: 2.5, category: "教育", merchant: "培训机构", fill: "#93c5fd" },
    ],
