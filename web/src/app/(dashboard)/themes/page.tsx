        ...
        {themes.map((theme) => {
          ...
          return (
            ...
            >
              ...
              {/* 主卡片 */}
              <div
                className="relative overflow-hidden rounded-[18px] sm:rounded-[24px] transition-transform duration-200 group-hover:scale-[1.01] group-active:scale-[0.99] w-full"
                style={{
                  minHeight: "260px",
                  background: isNova
                    ? theme.preview.shell
