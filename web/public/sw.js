const CACHE_NAME = 'xfdashboard-v1';
const STATIC_CACHE_NAME = 'xfdashboard-static-v1';
const DYNAMIC_CACHE_NAME = 'xfdashboard-dynamic-v1';
...
self.addEventListener('push', (event) => {
  ...
  let data = { title: 'XFDashboard', body: '您有新的通知' };
